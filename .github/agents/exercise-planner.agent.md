...
description: Helps plan out and outline a GitHub Skills exercise
argument-hint: Outline what the exercise will be about
target: vscode
disable-model-invocation: true
tools: [vscode/askQuestions, execute/getTerminalOutput, read, agent, search, web, 'context7/*', github/issue_read]
agents: [Plan]
handoffs:
