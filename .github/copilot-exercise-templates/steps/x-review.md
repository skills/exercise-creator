...
- **Example**: Learned how to use Copilot inline suggestions, Chat, and Edits.
- **Example**: Used Copilot to generate commit messages and pull request summaries.
- **Example**: Learned how to request Copilot to review your code.

### What's next?

- **Example**: Continue working on the project
...
- **Example**: Try building your first [GitHub Copilot Extension](https://github.com/skills/your-first-extension-for-github-copilot)
