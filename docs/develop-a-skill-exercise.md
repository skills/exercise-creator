# Develop a Skills Exercise

There are a few roles related to Skills Exercise development.
...
- **Skills Catalog Development** - A holistic view of all Skills exercises. Provide templates, reusable workflows, storylines, and toolkits so the catalog feels cohesive, maintainable, and inviting.

## Tools

- [overview app](../overview-app/README.md) - A no-install simple web application that lists all Skills exercises and the topics they cover.
...
Please use the issue template for a guide and checklist to creating a new Skills exercise. It will provide links back to these docs.

<a id="copy-exercise" href="https://github.com/skills/skills-manager/issues/new?template=new-skills-exercise-guide.md&title=New+Exercise%3A+%28set+title%29">
      <img src="https://img.shields.io/badge/👩‍🚀_Create_New_Exercise-008000" height="25pt"/>
   </a>

### Selecting a New Exercise
...
### Exercise Organization and Flow

Exercises are communicated to the learner using an Issue and comments, similar to a real development workflow.

- Exercises are organized into 5 or less steps.
...
- All exercises files are stored in the `.github/steps/` folder.
...
Exercises are meant to build on one another and increasingly enable the learner. They are also not meant to be boring learning materials! Use the storyline, GitHub's history/characters, and your imagination to make it interesting.

- Each exercise should use one of the chosen storylines.
- If an exercise builds on the work of a previous exercise, provide that previous work as the starting point.
...
- All grading workflows are stored in the exercise's `.github/workflows/` folder.
- Ensure the workflows are easy to follow and include references. Many developers will use them as references.

### Maintainability

GitHub Skills exercises are not version safe. As such they will become out of date as GitHub evolves. Here are recommendations to consider.
...
Most grading workflows can be verified locally before testing them in the actual exercise flow.
...
The only true test is giving the exercise an actual try.

- Try the exercise yourself on actual GitHub. See what happens, take notes, and fix bugs.
...
- Check in our your exercise regularly for any reported issues or out-of-date information.

- Keep everything you need in the one exercise repository.
- If an exercise must be private during development, create an organization for your exercises, make your exercises private, and invite the specific users that need these exercises to your organization.
